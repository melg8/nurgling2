...
public class PortalMarkerTracker {
    ...
    /**
     * Pending transition for retry (when GridInfo not available).
     */
    private LayerTransition pendingTransition = null;
    private long pendingTransitionCreatedTime = 0;
    private static final long PENDING_TRANSITION_TIMEOUT_MS = 60000; // 60 seconds for GridInfo to load
    ...
    public void tick() {
        ...
        try {
            // First, try to process any pending transition (retry if GridInfo was not available)
